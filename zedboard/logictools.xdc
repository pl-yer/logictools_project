...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property -dict { PACKAGE_PIN Y11 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[0]}];  # "JA1"
set_property -dict { PACKAGE_PIN AA11 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[1]}];  # "JA2"
set_property -dict { PACKAGE_PIN Y10 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[2]}];  # "JA3"
set_property -dict { PACKAGE_PIN AA9 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[3]}];  # "JA4"
set_property -dict { PACKAGE_PIN AB11 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[4]}];  # "JA7"
set_property -dict { PACKAGE_PIN AB10 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[5]}];  # "JA8"
set_property -dict { PACKAGE_PIN AB9 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[6]}];  # "JA9"
set_property -dict { PACKAGE_PIN AA8 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[7]}];  # "JA10"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property -dict { PACKAGE_PIN W12 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[8]}];  # "JB1"
set_property -dict { PACKAGE_PIN W11 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[9]}];  # "JB2"
set_property -dict { PACKAGE_PIN V10 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[10]}];  # "JB3"
set_property -dict { PACKAGE_PIN W8  IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[11]}];  # "JB4"
set_property -dict { PACKAGE_PIN V12 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[12]}];  # "JB7"
set_property -dict { PACKAGE_PIN W10 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[13]}];  # "JB8"
set_property -dict { PACKAGE_PIN V9  IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[14]}];  # "JB9"
set_property -dict { PACKAGE_PIN V8  IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[15]}];  # "JB10"

# ----------------------------------------------------------------------------
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property -dict { PACKAGE_PIN AB6 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[16]}];  # "JC1_N"
set_property -dict { PACKAGE_PIN AB7 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[17]}];  # "JC1_P"
set_property -dict { PACKAGE_PIN AA4 IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[18]}];  # "JC2_N"
set_property -dict { PACKAGE_PIN Y4  IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[19]}];  # "JC2_P"
set_property -dict { PACKAGE_PIN T6  IOSTANDARD LVCMOS33 } [get_ports {ar_pg_clk}];                # "JC3_N"
# set_property -dict { PACKAGE_PIN R6  IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[21]}];  # "JC3_P"
# set_property -dict { PACKAGE_PIN U4  IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[22]}];  # "JC4_N"
# set_property -dict { PACKAGE_PIN T4  IOSTANDARD LVCMOS33 } [get_ports {arduino_gpio_tri_io[23]}];  # "JC4_P"

# ----------------------------------------------------------------------------
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property -dict { PACKAGE_PIN W7  IOSTANDARD LVCMOS33 } [get_ports {pmodb_gpio_tri_io[1]}];  # "JD1_N"
set_property -dict { PACKAGE_PIN V7  IOSTANDARD LVCMOS33 } [get_ports {pmodb_gpio_tri_io[0]}];  # "JD1_P"
set_property -dict { PACKAGE_PIN V4  IOSTANDARD LVCMOS33 } [get_ports {pmodb_gpio_tri_io[3]}];  # "JD2_N"
set_property -dict { PACKAGE_PIN V5  IOSTANDARD LVCMOS33 } [get_ports {pmodb_gpio_tri_io[2]}];  # "JD2_P"
set_property -dict { PACKAGE_PIN W5  IOSTANDARD LVCMOS33 } [get_ports {pmodb_gpio_tri_io[5]}];  # "JD3_N"
set_property -dict { PACKAGE_PIN W6  IOSTANDARD LVCMOS33 } [get_ports {pmodb_gpio_tri_io[4]}];  # "JD3_P"
set_property -dict { PACKAGE_PIN U5  IOSTANDARD LVCMOS33 } [get_ports {pmodb_gpio_tri_io[7]}];  # "JD4_N"
set_property -dict { PACKAGE_PIN U6  IOSTANDARD LVCMOS33 } [get_ports {pmodb_gpio_tri_io[6]}];  # "JD4_P"
...
# ---------------------------------------------------------------------------- 
# set_property PACKAGE_PIN P16 [get_ports {push_button[0]}];  # "BTNC"
set_property -dict { PACKAGE_PIN R16 IOSTANDARD LVCMOS33 } [get_ports {push_button[2]}];  # "BTND"
set_property -dict { PACKAGE_PIN N15 IOSTANDARD LVCMOS33 } [get_ports {push_button[0]}];  # "BTNL"
set_property -dict { PACKAGE_PIN R18 IOSTANDARD LVCMOS33 } [get_ports {push_button[3]}];  # "BTNR"
set_property -dict { PACKAGE_PIN T18 IOSTANDARD LVCMOS33 } [get_ports {push_button[1]}];  # "BTNU"
